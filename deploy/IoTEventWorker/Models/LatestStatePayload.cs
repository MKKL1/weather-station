...
public class LatestStatePayload(DateTime lastEventTs, string lastRawId, float? temperature, float? humidity, float? pressure, Histogram<byte>? rain, float? rainfallMmPerTip)
{
